...
public class MemberLoginServiceImpl implements MemberLoginService {
    ...
    @Override
    public Boolean register(LoginParam registerParam) {
        String password = PasswordEncodeUtil.bcryptEncode(registerParam.getPassword());
        String userName = registerParam.getUsername();
        memberDao.register(userName,password);
        return true;
    }
}
